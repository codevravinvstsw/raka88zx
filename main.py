...
bot = telebot.TeleBot('888639076:AAFnPvtUhEaxBrzIgI9anxombISA5nJ64Xs')
...
def command_ltc():
  try:
     ...
     bot.send_message(botadmin, "ltc error man.. WTF 😠")
...
def command_doge():
  try:
     ...
     bot.send_message(botadmin, "doge error man.. WTF 😠")
...
def command_text_bal(m):
  try:
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [ETH]")
...
def command_text_bal(m):
  try:
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [LTC]")
...
def command_text_bal(m):
  try:
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [DOGE]")
...
def command_text_bal(m):
  try:
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [BCH]")
...
def command_text_bal(m):
  try:
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [DASH]")
...
def command_text_bal(m):
  try:
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [ETC]")
...
def command_text_bal(m):
  try:
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [ZEC]")
...
def withdraw_ltc(m):
  try:
    ...
    adrqt.update({cid: "LTC"})
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [Litecoin]") 
...
def withdraw_ltc(m):
  try:
    ...
    adrqt.update({cid: "DOGE"})
     ...
     bot.send_message(botadmin, "Error man.. WTF 😠 [Dogecoin]")
...
def command_default(m):
  try:
     ...
     bot.send_message(cid, "Something went wrong.. Plzz try again")
